/**
  * @file ArbolGeneral.h
  * @brief Fichero cabecera del TDA ArbolGeneral
  * 
  */
...
/**
  ...
  *
  * Sea @e T, un árbol general sobre el tipo @e Tbase. Entonces el invariante de 
  * representación es
  ...
  *
  * Sea @e T un árbol general sobre el tipo @e Tbase, entonces si denotamos también
  * Árbol(T.laraiz), es decir, como el árbol que cuelga de su raíz, 
